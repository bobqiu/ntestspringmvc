	...
	$('#bp_more').click(function()
	{
		...
		switch (window.location.hash)
		{
			default:
				...
				var request_url = G_BASE_URL + '/home/index/' + $(this).attr('data-page') + '/filter/' + cur_filter;

			break;

			case '#draft_list__draft':
				/*var request_url = G_BASE_URL + '/home/ajax/draft/page-' + $(this).attr('data-page');*/
				var request_url = G_BASE_URL + '/home/draft/' + $(this).attr('data-page');
			...
			case '#invite_list__invite':
				...
				var request_url = G_BASE_URL + '/home/invite/' + $(this).attr('data-page');
			break;

			case '#focus_topic__focus':
				/*var request_url = G_BASE_URL + '/topic/ajax/focus_topics_list/page-' + $(this).attr('data-page');*/
				var request_url = G_BASE_URL + '/topic/focus/' + $(this).attr('data-page');
			break;
		}
...
function check_actions_new(time)
{
	...
	$.get(G_BASE_URL + '/home/checknew/time/' + time, function (result)
	{
		if (result.errno == 1)
		{
