...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		toolbars : [ [ "bold", "italic",
						...
						"justifyjustify", "indent", "removeformat", "formatmatch","insertcode", "pagebreak", "insertimage", "music",
				"insertvideo", "horizontal", "anchor", "blockquote", "emotion",
				"template", "insertunorderedlist", "insertorderedlist",
				"unlink", "link", "selectall", "preview", 
				"autotypeset", "paragraph", "rowspacingbottom",
				"rowspacingtop", "lineheight", "fontfamily", "fontsize",
